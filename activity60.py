...
# 3) Create a display surface (window) of size 400x400 using `pygame.display.set_mode(...)`
#    and store it in `window`.

# 4) Fill the window with white color using `window.fill((255, 255, 255))`.

# 5) Define a color constant `GREEN = (0, 255, 0)` using RGB format.
